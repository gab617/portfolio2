...
const variants = [
  ...
  { name: "Caleidoscopio2", description: "Efecto caleidoscopio especular" },
    ...
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-gradient-to-b from-slate-900 via-indigo-900 to-slate-900">
      ...
      {textPosition === "top" ? (
        <div className="absolute top-6 left-1/2 -translate-x-1/2 text-center w-full px-4">
          <h1 className="text-3xl font-black text-white tracking-[0.2em]">
            {eventInfo.title}
          </h1>
        ...
        <div className="absolute bottom-24 left-1/2 -translate-x-1/2 text-center w-full">
          <h1 className="text-4xl font-black text-white tracking-[0.25em]">
            {eventInfo.title}
          </h1>
          <div className="flex justify-center gap-3 mt-2">
            <span className="w-8 h-[1px] bg-white/50" />
          ...
          <p className="text-purple-300 text-xs mt-1 tracking-widest">
            {eventInfo.place}
          </p>
        </div>
      )}
      ...
      <div
        className={`absolute ${textPosition === "top" ? "bottom-6" : "bottom-6"} left-1/2 -translate-x-1/2 flex items-center gap-3`}
      >
    ...
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-gradient-to-br from-amber-950 via-yellow-900 to-amber-950">
      ...
      {textPosition === "top" ? (
        <div className="absolute top-4 left-1/2 -translate-x-1/2 text-center w-full px-4">
          <h1 className="text-2xl font-bold text-amber-100 tracking-[0.3em]">
            {eventInfo.title}
          </h1>
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-8"} left-1/2 -translate-x-1/2 bg-gradient-to-r from-amber-500 to-yellow-500 px-8 py-2 rounded-sm`}
      >
    ...
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-black">
      ...
      {textPosition === "top" ? (
        <div className="absolute top-4 left-1/2 -translate-x-1/2 text-center">
          <h1 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-white to-pink-400 tracking-widest">
            {eventInfo.title}
          </h1>
        </div>
      ) : (
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-6"} left-1/2 -translate-x-1/2 px-8 py-2 bg-gradient-to-r from-cyan-600 to-pink-600 rounded-full`}
      >
...
function Variant4TwoImages({ eventInfo }) {
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-black">
      {/* Fondo */}
      <div className="absolute inset-0 bg-gradient-to-br from-green-900/30 via-black to-green-900/40" />
      ...
      "
      >
        <Img index={0} className="w-full h-full object-cover" />
      </div>

      {/* Imagen vertical principal */}
      <div
        className="
        absolute 
        top-[270px] 
      ...
      >
        {/* marcos decorativos */}
        <div className="absolute inset-0 border border-white/10 rounded-lg rotate-[8deg]" />
        <div className="absolute inset-2 border border-white/10 rounded-lg rotate-[4deg]" />
        ...
        "
        >
          <Img index={1} className="w-full h-full object-cover" />
        </div>
      </div>
...
function Variant5({ eventInfo, textPosition }) {
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-8"} left-1/2 -translate-x-1/2 px-8 py-3 bg-white/10 backdrop-blur rounded-full border border-white/20`}
      >
        <span className="text-white font-bold">{eventInfo.price}</span>
      </div>
    </div>
...
function Variant6({ eventInfo, textPosition }) {
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-zinc-900">
      <div className="absolute top-0 left-0 w-[70%] h-[85%]">
        <Img index={0} className="w-full h-full" />
      </div>
      ...
      {textPosition === "top" ? (
        <div className="absolute top-8 left-8 text-left">
          <h1 className="text-4xl font-black text-white tracking-[0.1em]">
            {eventInfo.title}
          </h1>
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-8"} left-8 bg-white px-6 py-2 rounded-full`}
      >
...
function Variant7({ eventInfo, textPosition }) {
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950">
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-8"} left-1/2 -translate-x-1/2 bg-white px-8 py-2 rounded-full`}
      >
    ...
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-black">
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-1/3 h-full">
          <Img index={0} className="w-full h-full opacity-50 blur-sm" />
        </div>
        <div className="absolute top-0 left-1/3 w-1/3 h-full">
          <Img index={1} className="w-full h-full opacity-60 blur-sm" />
        </div>
        <div className="absolute top-0 left-2/3 w-1/3 h-full">
          <Img index={2} className="w-full h-full opacity-50 blur-sm" />
        </div>
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <div
          className="absolute w-44 h-60 rounded-lg overflow-hidden shadow-[0_0_80px_rgba(255,255,255,0.2)] z-10 rotate-[-2deg]"
          style={{ marginLeft: "20px" }}
        >
          <Img index={1} className="w-full h-full" />
        </div>
        <div
          className="absolute w-36 h-52 rounded-lg overflow-hidden shadow-[0_0_60px_rgba(255,255,255,0.15)] z-0 rotate-[5deg]"
          style={{ marginLeft: "-20px" }}
        >
          <Img index={2} className="w-full h-full" />
        </div>
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-8"} left-1/2 -translate-x-1/2 border border-white/30 px-8 py-2 rounded-full`}
      >
        <span className="text-white font-bold">{eventInfo.price}</span>
      </div>
    </div>
...
function Variant9({ eventInfo, textPosition }) {
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-black">
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-6"} left-1/2 -translate-x-1/2 bg-gradient-to-r from-fuchsia-600 to-cyan-600 px-8 py-2 rounded-full`}
      >
        <span className="text-white font-bold">{eventInfo.price}</span>
      </div>
    </div>
...
function Variant10({ eventInfo, textPosition }) {
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-950">
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-6"} left-1/2 -translate-x-1/2 border border-white/20 px-6 py-1 rounded-full`}
      >
  ...
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-black">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute top-[30%] left-0 w-[20%] h-[1px] bg-white/40"
...
function Variant12({ eventInfo, textPosition }) {
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-gradient-to-br from-slate-900 via-zinc-900 to-slate-900">
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-8"} left-8 bg-white px-6 py-2 rounded-lg`}
      >
        <span className="text-slate-900 font-bold">{eventInfo.price}</span>
      </div>
    </div>
...
function Variant13({ eventInfo, textPosition }) {
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-gradient-to-br from-stone-900 via-orange-900 to-stone-900">
      ...
      {textPosition === "top" ? (
        <div className="absolute top-8 left-1/2 -translate-x-1/2 text-center w-full">
          <h1 className="text-3xl font-bold text-orange-100 tracking-[0.2em]">
            {eventInfo.title}
          </h1>
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-8"} left-1/2 -translate-x-1/2 border border-orange-400/40 px-8 py-2 rounded-sm`}
      >
...
function Variant14({ eventInfo, textPosition }) {
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-black">
      <div className="absolute inset-0 flex">
        <div className="w-1/4 h-full border-r border-white/10">
          <div className="w-full h-[30%]">
            <Img index={0} className="w-full h-full grayscale" />
          </div>
          <div className="w-full h-[30%] border-y border-white/10">
            <Img index={1} className="w-full h-full grayscale" />
          </div>
          <div className="w-full h-[30%] border-y border-white/10">
            <Img index={2} className="w-full h-full grayscale" />
          </div>
        ...
        <div className="w-1/4 h-full border-r border-white/10">
          ...
          <div className="w-full h-[35%] border-y border-white/10">
            <Img index={0} className="w-full h-full grayscale" />
          </div>
          <div className="w-full h-[30%] border-y border-white/10">
            <Img index={1} className="w-full h-full grayscale" />
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-6"} left-1/2 -translate-x-1/2 bg-white px-8 py-2 rounded-full`}
      >
        <span className="text-black font-bold">{eventInfo.price}</span>
      </div>
    </div>
...
function Variant15({ eventInfo, textPosition }) {
  return (
    <div className="relative w-[360px] h-[640px] overflow-hidden rounded-2xl bg-gradient-to-br from-blue-950 via-cyan-950 to-blue-950">
      ...
      <div
        className={`absolute ${textPosition === "top" ? "top-[75%]" : "bottom-8"} left-1/2 -translate-x-1/2 bg-gradient-to-r from-cyan-500 to-blue-500 px-8 py-2 rounded-full`}
      >
        <span className="text-white font-bold">{eventInfo.price}</span>
      </div>
    </div>
    ...
    <div className="bg-black min-h-screen p-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-2xl font-bold text-white text-center mb-2">
          Catálogo de Publicidades
        </h1>
        <p className="text-white/60 text-center mb-6 text-sm">
          Formato 9:16 · Eventos
        </p>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
          ...
          <div className="text-white max-w-md space-y-4">
            ...
            <div className="bg-white/5 rounded-xl p-4 space-y-3">
              ...
              <p className="text-white/40 text-xs font-semibold uppercase mt-4">
                Editar Texto
              </p>
              <input
                type="text"
