  ...
  return (
    <section
      ...
      className="
        ...
        xl:bg-opacity-40"
    >
      <h1 className="text-center mb-4 text-3xl bg-black bg-opacity-75">
        Contacto
      </h1>
      ...
      <form action="" onSubmit={handleSubmit}>
        ...
        <div className="flex justify-center flex-col w-80 m-auto xl:w-1/2">
          ...
          <ButtonCircles type={"submit"} handleReset={handleReset} />
          <div>
            <div
              className={`flex justify-center ${
                emailEnviado ? "fade-in" : "fade-out"
              }`}
            >
              <button className="btn-mail-enviado lg:w1-2">
                <i className="animation"></i>Mail enviado!
